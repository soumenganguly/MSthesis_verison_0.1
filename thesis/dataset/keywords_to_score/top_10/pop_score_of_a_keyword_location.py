...
pdf_file = open('pdf16.pkl','rb')
poli_file = open('poli16.pkl','rb')
pul_file = open('pul16.pkl','rb')
umb_file = open('umb16.pkl','rb')

output_file = open('2016/keyword_pop_per_location.pkl','wb')
