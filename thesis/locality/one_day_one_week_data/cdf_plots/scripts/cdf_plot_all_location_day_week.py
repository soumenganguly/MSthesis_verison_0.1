...
g = open(sys.argv[5],'rb') # Same populations
h = open(sys.argv[6],'rb')
i = open(sys.argv[7],'rb')
j = open(sys.argv[8],'rb')
...
markers_on = [0.1]
plt.plot(sorted_data_i,yvals_i, 'b--*', markevery=0.1, markersize=10, label='ISP-City1 vs. ISP-City2-b')
plt.plot(sorted_data_j,yvals_j, 'c--+', markevery=0.1, markersize=10, label='ISP-City1 vs. Campus-City2')
plt.plot(sorted_data_k,yvals_k, 'm--o', markevery=0.1, markersize=10, label='ISP-City1 vs. ISP-City2-a')
plt.plot(sorted_data_l,yvals_l, 'y--x', markevery=0.1, markersize=10, label='ISP-City2-a vs. Campus-City2')
...
plt.plot(sorted_data_o,yvals_o, ':', markevery=0.1, markersize=10, label='ISP-City2-b vs. ISP-City2-b')
plt.plot(sorted_data_p,yvals_p, '--', markevery=0.1, markersize=10, label='ISP-City1 vs. ISP-City1')
plt.plot(sorted_data_q,yvals_q, 'g-.,', markevery=0.1,markersize=10, label='Campus-City2 vs. Campus-City2')
plt.plot(sorted_data_r,yvals_r, 'r-', markevery=0.1,markersize=10, label='ISP-City2-a vs. ISP-City2-a')
...
plt.xlabel('keyword popularity ratio', fontsize=22)
plt.ylabel('CDF', fontsize=22)
plt.xscale('log')

#plt.show()

plt.savefig('all_locations_oneday.png')
