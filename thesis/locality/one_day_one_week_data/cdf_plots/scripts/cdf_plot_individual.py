...
markers_on = [0.1]
plt.plot(sorted_data_i,yvals_i, '--o', markevery=0.1, label='ISP-City2-a vs. Campus-City2')
plt.plot(sorted_data_j,yvals_j, '-*', markevery=0.1,color='xkcd:green',label='ISP-City2-a vs. ISP-City2-a')
plt.plot(sorted_data_k,yvals_k, 'r:+',markevery=0.1,label='Campus-City2 vs. Campus-City2')
